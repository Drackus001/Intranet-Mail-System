    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            ...
            <div class="header-right">
              ...
              <a href="message-task.py" class="btn btn-info" title="New Message"><b>30 </b><i class="fa fa-envelope-o fa-2x"></i></a>
                ...
                <ul class="nav" id="main-menu">
                    <li>
                        <div class="user-img-div">
                            <img src="IMS.jpg" class="img-thumbnail" />
...
print """ 
                    ...
                    <li>"""
print "<a class='active-menu' href='index_student.py?sid="+str(sid)+"'><i class='fa fa-ge'></i>HOME</a>"
print "</li><li>"
...
print "</li><li>"
print "<a href='new_Group.py?sid="+str(sid)+"'><i class='fa fa-plus-circle'></i>New Group</a>"
print "</li><li>"                    
