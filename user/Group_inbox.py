...
print """                    </li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">GROUP_INBOX</h1>
...
"""
a="select * from group_mail where Group_no='"+str(no)+"'"
cursor.execute(a)
row=cursor.fetchall()
i=0
for row in cursor:
	i=i+1
	no=row[0]
	print "<tr><td><a href='group_mailinfo.py?sid="+base64.b64encode(str(sid))+"&no="+str(no)+"'>",i,"</a></td><td>",row[6],"</td><td>",row[3],"</td><td>",row[5],"</td></tr>"
