...
print"<a href='inbox.py?sid="+base64.b64encode(str(sid))+"'>"
print"""                             <div class="portfolio-item awesome mix_all" data-cat="awesome" >


                                        <img src="Inbox.jpg" class="img-responsive " alt="" />
                                        <div class="overlay">
                                            <p>
                                              INBOX
                                            </p>
...
print"<a href='Compose.py?sid="+base64.b64encode(str(sid))+"'>"
print"""                            <div class="portfolio-item landscape mix_all" data-cat="landscape" >


                                        <img src="ComposeMail.png" class="img-responsive " alt="" />
                                        <div class="overlay">
                                            <p>
                                            COMPOSE MAIL
                                            </p>
...
print"<a href='sentmail.py?sid="+base64.b64encode(str(sid))+"'>"
print"""                           
                                    <div class="portfolio-item nature mix_all" data-cat="nature" >


                                        <img src="ForwardMail.jpg" class="img-responsive " alt="" />
                                        <div class="overlay">
                                          <p>
...
print"<a href='Label.py?sid="+base64.b64encode(str(sid))+"'>"
print"""                                    <div  class="portfolio-item nature mix_all" data-cat="nature" >
...
print"<a href='Group.py?sid="+base64.b64encode(str(sid))+"'>"
print"""                            <div class="portfolio-item landscape mix_all" data-cat="landscape" >


                                        <img src="Group.png" class="img-responsive " alt="" />
                                        <div class="overlay">
                                            <p>
                                            Group
                                            </p>
