...
if (dd==str(1)):
	if (gn and gm):
		gm=gm+","+sname
		cursor.execute("INSERT INTO Group_info (Group_name,Members_id,date,Group_admin) values  ('"+gn+"','"+gm+"','"+time+"','"+sname+"')")
		sql = """commit"""
		cursor.execute(sql)
...
print """                                    
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">New Group</h1>
                        '
...
print"""
                        ...
                        <div class="panel-body">
                            <form role="form" method="post" action="new_group.py">
                                        
                                 <div class="form-group">
                                            <label>Group name:</label>
                                            <input class="form-control" type="text" name="gn" placeholder="Enter Your Group Name.">
                                            <label>members_id:</label>
                                            <input class="form-control" type="text" name="gm" placeholder="Enter Your Group Member ID">"""
