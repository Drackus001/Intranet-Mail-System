...
print """                    </li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">G_MAIL_INFO</h1>
...
for row in cursor:
	i=i+1
	no=row[0]
	print "<tr><td>Sender ID.</td><td>",row[6],"<tr><td >Subject</td><td>",row[3],"<tr><td colspan='2'>Message:-</td></tr></tr>"
	print "<table><tr><td><textarea style='margin: 0px; height: 346px; width: 953px;'disabled='true' >",base64.b64decode(row[2]),"</textarea></td></tr></table>"

print "<a href='reply.py?sid="+base64.b64encode(str(sid))+"&no="+str(no)+"&gr="+str(1)+"'><button type='submit' class='btn btn-danger'>Reply</button></a>"
print "<a href='forwardmail.py?sid="+base64.b64encode(str(sid))+"&no="+str(no)+"&gf="+str(1)+"'><button type='submit' class='btn btn-danger'>forward</button></a>"
