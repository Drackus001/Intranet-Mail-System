...
for row in cursor:
        sname=row[0]     
if (R==str(1)):
        SI=base64.b64decode(form.getvalue('SI'))
        cursor.execute("delete  from session where session_id='"+SI+"'")
        sql = """commit"""
        cursor.execute(sql)        
...
print "<meta http-equiv='refresh' content='5;url=ActiveUser.py?sid="+base64.b64encode(str(sid))+"' />"  
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                   """
n=cursor.execute("select * from session where session_id!='"+sid+"'")
row=cursor.fetchall()
...
for row in cursor:
        ...
        for row1 in cursor1:
                ...
                print "</td><td><a href='ActiveUser.py?sid="+base64.b64encode(str(sid))+"&R="+str(1)+"&SI="+base64.b64encode(row[0])+"'>Remove</a></td></tr>"
