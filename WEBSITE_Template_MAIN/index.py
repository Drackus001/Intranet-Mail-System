      ...
      <div class="container">
        ...
        <div class="navbar-header">
          <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
            ...
            <a class="navbar-brand" href="index.html">Intranet <span class="themecolor">Mail </span>System</a>
        </div>
    ...
    <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="#seven" class="page-scroll">Feature</a></li>
            <li><a href="#six" class="page-scroll">Log In</a></li>
            <li><a href="#three" class="page-scroll">Developer</a></li>
...
<section class="main-heading" id="home">
       <div class="overlay">
        ...
        <h1 class="main-heading-title">WE PROVIDES <span class="main-element themecolor" data-elements="Simple GUI,Mailing Facility,Easy communication,Gruoping Facility,privacy,Chatting facility,security"></span></h1>
        ...
        <div class="btn-bar">
          <a href="#six" style=" background-color: #66e754" class="btn btn-custom theme_background_color">Ge Started</a>
        </div>
      </div>
               </div>
           </div>
 ...
 <center>
  ...
  <div id="login-page">
	  	<div class="container">
		      ...
		      <form class="form-login" action="index.html"><br/>
		     <h3 class="title">sign in <span class="themecolor">Now</span></h3>
		        ...
		        <div class="login-wrap"><br/>
		            ...
		            <div class="registration">
		                Don't have an account yet? &nbsp; <a class="" href="#">
		                    Create an account
		                </a>
		            </div>
